(function () {
    try {
        ...
        var variation_name = "travelshift-CS2-T4-v3";
        ...
        var newContent = `<div class="video-container" style="display:none">
                <div class="headingsubheading">
                   ...
                   <p>As Iceland’s largest travel marketplace, we have more providers than any other website and guarantee the lowest prices.</p>
                </div>
                <div id='creVideo'> </div>
        </div>`;
        ...
        /* Variation Init */
        function init() {
            document.querySelector("body").classList.add("travelshift-CS2-T4-v3")
