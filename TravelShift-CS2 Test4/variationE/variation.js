(function () {
    try {
        ...
        var variation_name = "travelshift-CS2-T4-v4";
        ...
        var newContent = `<div class="video-container" style="display:none">
                <div class="headingsubheading">
                   <h1>Everything you need, all in one place, for your dream Icelandic adventure (and the best prices, too)</h1>
                   <p>As Iceland’s largest travel marketplace, we search over 2000 travel service providers to find you the best deals at the best prices—guaranteed.</p>
                </div>
                <div id='creVideo'> </div>
        </div>`;
        ...
        /* Variation Init */
        function init() {
            document.querySelector("body").classList.add("travelshift-CS2-T4-v4")
