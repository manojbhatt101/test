(function () {
    try {
        ...
        var variation_name = "travelshift-CS2-T4-v2";
        ...
        function initYTVideo() {
            window.crePlayer = new YT.Player('creVideo', {
                ...
                playerVars: {
                    ...
                    'loop': 1   // Hide video info (title and uploader) (optional)
                },
                events: {
        ...
        function onPlayerStateChange(event) {
            ...
            if (playerState == YT.PlayerState.ENDED) {
                window.crePlayer && window.crePlayer.seekTo(0);
        ...
        /* Variation Init */
        function init() {
            document.querySelector("body").classList.add("travelshift-CS2-T4-v2")
